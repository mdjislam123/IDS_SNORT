...
Snort's rule language is used in **community-ftp.rules** to identify patterns or characteristics in FTP packets that trigger alerts or actions when matched.
...
Now, I will add a few local custom rules in **local.rules** file to test the snort application. To edit the local.rules file type - 
...
If you successfully saved the rules in the **local.rules** file, and Snort’s configuration file successfully saved the configuration. You will see this message below – 
...
Now, I will start the Kali machine and will try to send an FTP connection request from Kali to Ubuntu. To send an FTP request, enter the following command in the terminal - 
...
Here you can see the log **12/28-06:43:44.471246 [**] [1:60001:1] FTP Attempted [**] [Priority: 0] {TCP} 192.168.1.208:65476 -> 192.168.1.103:21.**
...
•	12/28-06:43:44.471246: This part is called Timestamp. Indicates the date and time of the event when this entry was logged. In this case, the date is December 28th, and the time is  
  06:43:44.471246.
...
Here you can see we have another log **12/28-06:44:08.559210 [**] [1:60002:1] SSH Attempted [**] [Priority: 0] {TCP} 192.168.1.208:65491 -> 192.168.1.103:22.**
